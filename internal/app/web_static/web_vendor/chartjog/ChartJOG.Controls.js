/* Built by scripts/build-chart-package.js. Edit v2/packages-src/ChartJOG.Controls.source.js instead. */
(() => {
  ...
  var require_helpers_dataset = __commonJS({
    "node_modules/chart.js/dist/chunks/helpers.dataset.cjs"(exports) {
      "use strict";
  ...
  var require_chart = __commonJS({
    "node_modules/chart.js/dist/chart.cjs"(exports) {
      "use strict";
      var helpers_dataset = require_helpers_dataset();
      require_color();
      var Animator = class {
        constructor() {
          this._request = null;
      ...
      var DatasetController = class {
        ...
        parseObjectData(meta, data, start, count) {
          ...
          for (i = 0, ilen = count; i < ilen; ++i) {
            ...
            item = data[index2];
            parsed[i] = {
              x: xScale.parse(helpers_dataset.resolveObjectKey(item, xAxisKey), index2),
              y: yScale.parse(helpers_dataset.resolveObjectKey(item, yAxisKey), index2)
            };
          }
          return parsed;
        }
        ...
        _resolveElementOptions(elementType, mode = "default", index2) {
          ...
          const sharing = this.enableOptionSharing && helpers_dataset.defined(index2);
          if (cached) {
      ...
      var DoughnutController = class extends DatasetController {
        ...
        parse(start, count) {
          ...
          if (this._parsing === false) {
            ...
            if (helpers_dataset.isObject(data[start])) {
              ...
              getter = (i2) => +helpers_dataset.resolveObjectKey(data[i2], key);
            }
            let i, ilen;
            for (i = start, ilen = start + count; i < ilen; ++i) {
        ...
        getLabelAndValue(index2) {
          ...
          const value = helpers_dataset.formatNumber(meta._parsed[index2], chart.options.locale);
          return {
            label: labels[index2] || "",
            value
          };
      ...
      var PolarAreaController = class extends DatasetController {
        ...
        getLabelAndValue(index2) {
          ...
          const chart = this.chart;
          const labels = chart.data.labels || [];
          const value = helpers_dataset.formatNumber(meta._parsed[index2].r, chart.options.locale);
          return {
            label: labels[index2] || "",
            value
          };
        ...
        _computeAngle(index2, mode, defaultAngle) {
          return this.chart.getDataVisibility(index2) ? helpers_dataset.toRadians(this.resolveDataElementOptions(index2, mode).angle || defaultAngle) : 0;
        }
      };
      ...
      var eventListenerOptions = helpers_dataset.supportsEventListenerOptions ? {
        passive: true
      } : false;
      ...
      function registerDefaults(item, scope, parentScope) {
        const itemDefaults = helpers_dataset.merge(/* @__PURE__ */ Object.create(null), [
      ...
      function mergeScaleConfig(config, options) {
        ...
        Object.keys(configScales).forEach((id) => {
          ...
          scales2[id] = helpers_dataset.mergeIf(/* @__PURE__ */ Object.create(null), [
            {
              axis
            },
            scaleConf,
        ...
        config.data.datasets.forEach((dataset) => {
          ...
          Object.keys(defaultScaleOptions).forEach((defaultID) => {
            ...
            helpers_dataset.mergeIf(scales2[id], [
              {
                axis
              },
              configScales[id],
      ...
      var Config = class {
        ...
        createResolver(scopes, context, prefixes = [
          ...
          return helpers_dataset.isObject(context) ? helpers_dataset._attachContext(resolver, context, void 0, descriptorDefaults) : resolver;
        }
      };
      ...
      var hasFunction = (value) => helpers_dataset.isObject(value) && Object.getOwnPropertyNames(value).some((key) => helpers_dataset.isFunction(value[key]));
      ...
      var Chart = class {
        ...
        buildOrUpdateScales() {
          ...
          helpers_dataset.each(scales2, (scale) => {
      ...
      __publicField(Chart, "defaults", helpers_dataset.defaults);
      __publicField(Chart, "instances", instances);
      __publicField(Chart, "overrides", helpers_dataset.overrides);
      ...
      function pathArc(ctx, element, offset, spacing, end, circular) {
        ...
        const beta = Math.max(1e-3, alpha * outerRadius - offset / helpers_dataset.PI) / outerRadius;
      ...
      */
      ...
      function skipOrLimit(skip2, value, min, max) {
        return skip2 ? 0 : helpers_dataset._limitValue(value, min, max);
      }
      ...
      function _resolveTarget(sources, index2, propagate) {
        ...
        while (fill2 !== false && visited.indexOf(fill2) === -1) {
          if (!helpers_dataset.isNumberFinite(fill2)) {
            return fill2;
          }
      ...
      function _decodeFill(line, index2, count) {
        ...
        if (helpers_dataset.isObject(fill2)) {
      ...
      function _getTargetPixel(fill2, scale) {
        ...
        if (fill2 === "start") {
          ...
          pixel = scale.top;
        } else if (helpers_dataset.isObject(fill2)) {
      ...
      function parseFillOption(line) {
        ...
        let fill2 = helpers_dataset.valueOrDefault(fillOption && fillOption.target, fillOption);
        if (fill2 === void 0) {
      ...
      var validIndex = (index2, max) => index2 === null ? null : helpers_dataset._limitValue(Math.round(index2), 0, max);
      ...
      var CategoryScale = class extends Scale {
        ...
        parse(raw, index2) {
          ...
          const labels = this.getLabels();
          index2 = isFinite(index2) && labels[index2] === raw ? index2 : findOrAddLabel(labels, raw, helpers_dataset.valueOrDefault(index2, raw), this._addedLabels);
      ...
      function generateTicks$1(generationOptions, dataRange) {
        ...
        if (minDefined && maxDefined && step && helpers_dataset.almostWhole((max - min) / step, spacing / 1e3)) {
          ...
          if (helpers_dataset.almostEquals(numSpaces, Math.round(numSpaces), spacing / 1e3)) {
      ...
      var log10Floor = (v) => Math.floor(helpers_dataset.log10(v));
      ...
      var RadialLinearScale = class extends LinearScaleBase {
        ...
        getIndexAngle(index2) {
          ...
          return helpers_dataset._normalizeAngle(index2 * angleMultiplier + helpers_dataset.toRadians(startAngle));
        }
        ...
        getPointPosition(index2, distanceFromCenter, additionalAngle = 0) {
          const angle = this.getIndexAngle(index2) - helpers_dataset.HALF_PI + additionalAngle;
          return {
  ...
  var require_auto = __commonJS({
    "node_modules/chart.js/auto/auto.cjs"(exports, module) {
      var chartjs = require_chart();
      var { Chart, registerables } = chartjs;
  ...
  // v2/packages-src/ChartJOG.Controls.source.js
  (function(global) {
    "use strict";
    var chartAutoModule = require_auto();
    ...
    function createChartConfig(control, model, rootNode) {
      ...
      return {
        ...
        options: {
          indexAxis: control.Horizontal ? "y" : "x",
          animation: false,
          responsive: true,
    ...
    function BarChart() {
      ...
      this.SetStateValue("horizontal", false);
    ...
    BarChart.prototype.ApplyState = function(prevState, nextState) {
      ...
      if (this._chartAdapter && (prevState.items !== nextState.items || prevState.labelField !== nextState.labelField || prevState.valueField !== nextState.valueField || prevState.seriesLabel !== nextState.seriesLabel || prevState.titleText !== nextState.titleText || prevState.horizontal !== nextState.horizontal)) {
    ...
    JOG.DefineControlProperty(BarChart.prototype, "Horizontal", {
      stateKey: "horizontal",
      normalize: function(value) {
        return !!value;
      }
    ...
    JOG.RegisterControl({
      ...
      metadata: {
        ...
        properties: ["Items", "LabelField", "ValueField", "SeriesLabel", "TitleText", "EmptyText", "Horizontal", "ThemePreset"],
        events: ["OnPointClick"],
...
chart.js/dist/chunks/helpers.dataset.cjs:
